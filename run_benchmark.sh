...
# run_benchmark.sh - Reusable benchmark runner for DLIO (ROS1)
set -e
...
echo "=========================================="
echo "Running DLIO benchmark (ROS1)"
...
IMAGE="${DLIO_IMAGE:-ghcr.io/mapshd/dlio2hdmapping:latest}"
...
docker run --rm -t \
    ...
    bash -lc "
      ...
      roslaunch ${DLIO_LAUNCH} >/tmp/dlio.log 2>&1 &
      LAUNCH_PID=\$!
      ...
      rosrun dlio-to-hdmapping listener \"\${REC_BAG}\" \"\${OUT_DIR}/hdmapping\"
    "
